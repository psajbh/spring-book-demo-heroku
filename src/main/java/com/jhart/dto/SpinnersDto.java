...
public class SpinnersDto {
	...
	public int hashCode() {
		return Objects.hash(displayDate, elapsedTime, endDate, id, playDate, player1, player2, player3, player4,
				player5, player6, player7, rv1, rv2, rv3, rv4, rv5, rv6, rv7, score1, score2, score3, score4, score5,
				score6, score7, startDate, winner);
	}
	@Override
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		SpinnersDto other = (SpinnersDto) obj;
		return 	Objects.equals(playDate, other.playDate) 
				...
				&& Objects.equals(score1, other.score1)	&& Objects.equals(score2, other.score2) 
				&& Objects.equals(score3, other.score3) && Objects.equals(score4, other.score4) 
